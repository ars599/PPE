...
path_o = "/g/data/p66/ars599/enso_metrix/output/"
...
dict_data = {
    "model": {
        "CM2G13": {
            "sst": { # pr sst ts ssh 
                ...
                "path + filename": "path_to_xml_file/ts_Amon_piControl_r3i1p13f1.xml",
                "varname": "ts",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
                # the CF standard_name is: land_area_fraction
                "path + filename_landmask": "path_to_xml_file/sftlf_fx_piControl.xml",
                "landmaskname": "sftlf",
            },
            "pr": {
                # the CF standard_name is: surface_temperature
                "path + filename": "path_to_xml_file/pr_Amon_piControl_r3i1p13f1.xml",
                "varname": "pr",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
            ...
            "lhf": {
                # the CF standard_name is: surface_temperature
                "path + filename": "path_to_xml_file/hfls_Amon_piControl_r3i1p13f1.xml",
                "varname": "hfls",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
    ...
    "observations": {
        ...
        "CM2G12": {
            "sst": {
                # the CF standard_name is: surface_temperature
                "path + filename": "path_to_xml_file/ts_Amon_piControl_r3i1p12f1.xml",
                "varname": "ts",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
            ...
            "pr": {
                # the CF standard_name is: surface_temperature
                "path + filename": "path_to_xml_file/pr_Amon_piControl_r3i1p12f1.xml",
                "varname": "ts",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
            ...
            "lhf": {
                # the CF standard_name is: surface_temperature
                "path + filename": "path_to_xml_file/hfls_Amon_piControl_r3i1p12f1.xml",
                "varname": "hfls",
                # the CF standard_name is: cell_area
                "path + filename_area": "path_to_xml_file/areacella_fx_piControl.xml",
                "areaname": "areacella",
...
dict_o, _ = ComputeCollection(mc_name, dict_data, model_name, netcdf=True, netcdf_name=fi_nc, 
                              observed_fyear=1050, observed_lyear=1100, modeled_fyear=1050, modeled_lyear=1100)
# save as json file
